...
% Förare stänger idag av systemen i dense traffic - inte avsedda för detta
% idag? cite??

%dynamics vary with time-gap and implementeringsgrad % Nu ett stycke med
%nackdelar, svårigheter och % fråga kring effekter av implementeringsgrad:
%Inte helt simpelt - adc kan öka problem \cite!  Utformning av eadc, förslag
%och potential. Vår ide - men finns förslag \cite!  eacc behöver väldigt hög
%implementeringsgrad eftersom de inte kan kommunicera annars Undersök effekter
...
Systems} at Chalmers University of Technology. Thanks to our advisor Kolbjørn
Tunstrøm.
