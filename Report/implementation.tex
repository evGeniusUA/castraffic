...
\begin{center}
\begin{table}{H}
\begin{tabular}{| Paramter | Description | Value |}
a & Max acceleration & $ 0.73 m/s^2 \\ \hline
b & Max brake & $ 1.5 m/s^2 $\\ \hline
T & Time headway & 1.5 s \\ \hline
$ l $ & Car length & 5 m \\ \hline
$ T_r $ & Reaction time & 0.2 s \\ \hline
